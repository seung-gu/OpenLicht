...
int Bluetooth_server::_str2uuid( const char *uuid_str, uuid_t *uuid ) 
{
...
sdp_session_t* Bluetooth_server::register_service(uint8_t rfcomm_channel) 
{
...
int Bluetooth_server::init_server() 
{
...
char* Bluetooth_server::read_server(int client) 
{
...
void Bluetooth_server::write_server(int client, char *message) 
{
...
bdaddr_t Bluetooth_server::bdaddr_any = {0, 0, 0, 0, 0, 0};
bdaddr_t Bluetooth_server::bdaddr_local = {0, 0, 0, 0xff, 0xff, 0xff};
char Bluetooth_server::input[1024] = { 0 };
